...
if (isset($_FILES['file'])) {
	try {
		...
		mail('contact@millemilliards.net', sprintf('[millemilliards] %d nouvelles identités ont été créées', $countIdentitiesCreated), sprintf("Le site regroupe dorénavant %d identités. \n\nIdentité initiale : http://www.millemilliards.net/identites/%s\n\nDes bisous !", $countIdentities, $url), 'From: Mille Milliards <noreply@millemilliards.net>' . "\r\n" );
